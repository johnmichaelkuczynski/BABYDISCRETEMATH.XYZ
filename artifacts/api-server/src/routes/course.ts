...
const WEEK_TITLES: Record<number, { title: string; summary: string }> = {
  1: {
    title: "Baby Discrete Math: The Math of Distinct Things",
    summary:
...
router.post(
  ...
  async (req, res): Promise<void> => {
    ...
    const sys =
      "You are an introductory discrete-math lecturer revising your own lecture at a student's request. " +
      ...
      "4. Stay accurate to the source material and to discrete math as a discipline. Do not invent fake facts, citations, or quotations.\n" +
...
router.post(
  ...
  async (req, res): Promise<void> => {
    ...
    const sys =
      "You are an introductory discrete-math lecturer adding illustrations to your own lecture. " +
      ...
      "4. Stay accurate to the source material and to discrete math as a discipline. Do not invent fake facts, statistics, citations, or quotations; keep examples plausibly illustrative, not presented as documented cases.\n" +
      "5. Use clear Markdown. Use $...$ for any inline math.\n" +
